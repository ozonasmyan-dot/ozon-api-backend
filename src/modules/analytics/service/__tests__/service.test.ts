    ...
    it('aggregates margins by month and sku and subtracts ad spend', async () => {
        const unitRepo = {
            getEconomyBySku: jest.fn().mockResolvedValue([
                { createdAt: new Date('2024-01-15'), sku: '1', status: 'delivered', margin: 100, costPrice: 50, totalServices: 10 },
                { createdAt: new Date('2024-01-20'), sku: '1', status: 'cancelled', margin: 0, costPrice: 0, totalServices: 0 },
                { createdAt: new Date('2024-02-05'), sku: '1', status: 'delivered', margin: 200, costPrice: 100, totalServices: 20 },
                { createdAt: new Date('2024-02-10'), sku: '2', status: 'delivered', margin: 300, costPrice: 150, totalServices: 30 },
            ]),
